...
4-vectors are vector objects that follow Lorentz transformation when we change observers of different velocity. You have already seen the position 4-vector $\vec{X}=\bmat ct\\x\\y\\z \emat$, which represents the spacetime coordinate. 
From the 4-position vector, we can also construct other kinds of 4-vectors as well.
