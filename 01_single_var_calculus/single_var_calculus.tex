...
\begin{itemize}
    \item \ul{\nth{1} intepretation - Area under curve}
        \aleq{
            ...
            \defeq\;  
            \lim_{\Delta x_i \to 0}\, \cul[YellowGreen]{\tikzmark{s1}\sum_{i=0}^{n-1}}\enspace 
            \tikzmark{h1}\cul[RoyalBlue]{f(\blue{\xi_i})}\cdot
            \tikzmark{w1}\cul[red]{\red{\Delta x_i}}
        }
        \addArrow[YellowGreen]{s1}{(10pt,-4.5ex)}{(10pt, -6ex)}{(10pt,-8ex)}{$\substack{\text{Sum} \\ \text{them all}}$}
        \addArrow[RoyalBlue]{h1}{(10pt,-1.5ex)}{(10pt, -3ex)}{(14pt,-5ex)}{$\substack{\text{height of} \\ \text{strips}}$}
        \addArrow[red]{w1}{(12pt,-1.5ex)}{(12pt, -3ex)}{(20pt,-5ex)}{$\substack{\text{width of} \\ \text{strips}}$}
    \\
    ...
    \item \ul{\nth{2} intepretation - Weighted sum}
        \aleq{
            \int_b^a f(\blue{x}) \red{\dd{x}} \; 
            \defeq\;  
            \lim_{\Delta x_i \to 0}\, \cul[YellowGreen]{\tikzmark{s2}\sum_{i=0}^{n-1}}\enspace 
            \tikzmark{h2}\cul[RoyalBlue]{f(\blue{\xi_i})}\cdot
            \tikzmark{w2}\cul[red]{\red{\Delta x_i}}
        }
        \addArrow[YellowGreen]{s2}{(6pt,-4ex)}{(-4pt, -6ex)}{(-16pt,-7ex)}{$\substack{\text{Sum} \\ \text{them all}}$}
        \addArrow[RoyalBlue]{h2}{(10pt,-1.5ex)}{(10pt, -3ex)}{(14pt,-6ex)}{$\substack{\text{"weight"}\\\text{assigned to the} \\ \text{interval } [x_i, x_{i+1}]}$}
        \addArrow[red]{w2}{(12pt,-1.5ex)}{(18pt, -3ex)}{(35pt,-6ex)}{$\substack{\text{length of} \\ \text{interval } \\ [x_i, x_{i+1}]}$}
    \\
\end{itemize}
...
\begin{example} Constant Acceleration Motion \\
    ...
    \aleq{
        \bcase{
            v(t) &= v(0) + at \\
            s(t) &= s(0) + v(0)t + \half at^2 \tikzmark{suvat1}\\ 
            s(t)-s(0) &= \dfrac{v(t)-v(0)}{2}t \\ 
            v(t)^2 - v(0)^2 &= 2a[s(t)-s(0)] \tikzmark{suvat2}
        }
    }
    \addArrow[red]{suvat1}{(8pt,0.5ex)}{(36pt, 3ex)}{(76pt,3ex)}{$\substack{\text{Definition}\\\text{nothing to explain}}$}
    \addArrow[red]{suvat1}{(8pt,5ex)}{(36pt, 3.5ex)}{(76pt,3ex)}{}
    \addArrow[YellowGreen]{suvat2}{(8pt,0.5ex)}{(36pt, 3ex)}{(86pt,3ex)}{$\substack{\text{Can be derived by}\\\text{substitution of the above 2}}$}
    \addArrow[YellowGreen]{suvat2}{(8pt,5ex)}{(36pt, 3.5ex)}{(86pt,3ex)}{}
...
\aleq{
    ...
    &= \int F(t) \cdot \dd{[s(t)]} \\
    &= \int \tikzmark{Fstar}\cul[RoyalBlue]{F^*[s(t)]} \dd{[s(t)]}
}\\\\
\addArrow[RoyalBlue]{Fstar}{(20pt,-2ex)}{(20pt, -4ex)}{(20pt,-6ex)}
...
\begin{example} Gravitational force \& potential energy (PE)
    ...
    \aleq{
        F(\tikzmark{Fr}\red{r}) = -\frac{GMm}{\red{r}^2}
    }\\
    \addArrow[red]{Fr}{(4pt,-1.5ex)}{(4pt, -3.5ex)}{(20pt,-5ex)}{Force is a function of distance from the masses}
    ...
    \aleq{
        ...
        &= \tikzmark{PEminus}\red{-}\qty(\text{GPE at }r_2 - \text{GPE at }r_1)
    }\\
    \addArrow[red]{PEminus}{(5pt,-1ex)}{(5pt, -2.5ex)}{(10pt,-5.5ex)}
    ...
    \aleq{
        \text{PE} &= -\frac{GMm}{r} \\
        \text{Gravitational force} &= \tikzmark{Fminus}\red{-} \dvv{r}(\text{PE}) = -\frac{GMm}{r^2}
    }\\
    \addArrow[red]{Fminus}{(5pt,-1ex)}{(5pt, -3.5ex)}{(10pt,-4.5ex)}
