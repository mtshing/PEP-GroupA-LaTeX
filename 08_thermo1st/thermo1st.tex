...
\begin{enumerate}
    ...
    \aleq{
        \Acboxed[blue]{
            C_\yellow{P}(T) \equiv \qty(\dvv{U}{T}) + P\qty(\dvv{V}{T})= \frac{i+2}{2}nR = (\text{Constant})
        }
    }
\end{enumerate}
...
\begin{example}
    ...
    \aleq{
        \eta = 1 - \qty|\frac{\dfrac{i+2}{2}nR(T_4-T_3)}{\dfrac{i}{2}nR(T_1-T_4) + nRT_1\ln\qty(\dfrac{V_2}{V_1})}|
    }
