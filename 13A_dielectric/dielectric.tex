...
From chemistry, atoms in non-metalic substance join together by sharing electrons.
...
we can view a non-metal object (i.e. insulator, also called \bf{dielectric}) as a structure of charges, 
but using \bf{electric dipoles} as the basic unit.

\insertFig{stacking dipoles in ionic bond/ covalent bond}

Since electric dipoles emit E-field, theoretically all materials are sources of E-field.
...
So electric properties of materials are normally unobservable, 
unless we apply an external E-field to align the dipoles in some direction,
i.e. we \bf{polarize} the material.
...
\begin{itemize}
    ...
    \item $\chi_e>0$ for normal materials, because dipoles normally follow E-field's direction.
\end{itemize}
