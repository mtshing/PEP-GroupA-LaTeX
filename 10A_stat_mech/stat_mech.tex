...
\begin{center}
    \begin{minipage}{0.8\linewidth}
        \centering
        \includegraphics[width=\textwidth]{2box_prob}
    \end{minipage}
\end{center}
...
\begin{itemize}
    ...
    \item Multiplicity of macrostate 500L-500R is $C^{1000}_{500}$, 
        so its probability is $\dfrac{C^{1000}_{500}}{2^{1000}} \sim 10^{-2}$.
\end{itemize}

On average,
we will observe the balls evenly distributed in two boxes for $10^{299}$ times before observing them all in one box for 1 time.
But our universe is only 13 billion years old ($\sim 10^{14}$ seconds) - 
This is equivenlently saying: 1000L-0R state could never be observed again.
\begin{itemize}
...
\begin{minipage}{0.35\linewidth}
    \centering
    \includegraphics[width=\textwidth]{2box_E3}
\end{minipage}
