...
\begin{example}
    ...
    \begin{tabular}{>{\centering\arraybackslash}m{5ex}|
        ...
        >{\centering\arraybackslash}m{0.2\linewidth}}
        %
        $U$ & Macrostate & Multiplicity & Probability \\[1ex]
        \hline
        %
        $0$ & \includegraphics[width=\linewidth]{2box_E1} & $1$ & $\dinv{Z}$\\[1ex]
        \hline
        %
        $\epsilon$ & \includegraphics[width=\linewidth]{2box_E2} & $4$ & $\dfrac{4}{Z}$\\[1ex]
        \hline
        %
        $2\epsilon$ & \includegraphics[width=\linewidth]{2box_E3} & $6$ & $\dfrac{6}{Z}$\\[1ex]
        \hline
        %
        $3\epsilon$ & \includegraphics[width=\linewidth]{2box_E4} & $4$ & $\dfrac{4}{Z}$\\[1ex]
        \hline
        %
        $4\epsilon$ & \includegraphics[width=\linewidth]{2box_E5} & $1$ & $\dfrac{1}{Z}$\\[1ex]
        \hline
        \end{tabular}
\end{center}
