...
\begin{center}
    \red{What is the probability for $x$ to deviate by $\Delta x$? 
    i.e. Observing $x$ to be $x_0 + \Delta x$?}
\end{center}
...
\aleq{
    P\qty(x=x_0) 
    \ =\ \frac{\qty(\mstack{\text{\# of microstates that}\\\text{leads to observing }x=x_0})}{\qty(\text{Total \# of microstates})}
}
