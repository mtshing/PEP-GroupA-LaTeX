...
\begin{example}
    ...
    \aleq{
        ...
        &= \int_0^R \int_{0}^{\frac{\pi}{2}} \int_0^{2\pi} r^2 \cdot \rho\cdot r\sin^2\theta\dd{\phi}\dd{\theta}\dd{r} \\[1em]
        &= \int_0^R \int_{0}^{\frac{\pi}{2}} \int_0^{2\pi} r^3(1+r^2) \sin^2\theta\dd{\phi}\dd{\theta}\dd{r} \\[1em]
        &= \int_0^R r^3(1+r^2) \cdot \tkn{hemi}{\cul[blue]{2\pi r^2 \dd{r}}} \\[1em]
        &= \pi\qty(\frac{R^4}{2} + \frac{R^6}{3})
    }
