...
\begin{enumerate}
    ...
    storing energy that \red{can be released once the pipe stop moving.}
    ...
    \aleq{
        \text{W.D.} &= \vvec{F}_B \cdot \dd{\vvec{r}} = 0 \\
        &= q(\vvec{v}\cross\vvec{B})\cdot\dd{\vvec{r}} \\
        &= q\qty[(\vvec{v}_x+\vvec{v}_y)\cross B_z\hhat{z}]\cdot \qty(\dd{\vvec{x}}+\dd{\vvec{y}})\\
        %&= q\qty(-v_xB_z\hhat{y} + v_yB_z\hhat{x})\cdot \qty(\dd{\vvec{x}}+\dd{\vvec{y}})\\
        &= \cancelto[red]{0}{q(\vvec{v_x}\cross\vvec{B})\cdot\dd{\vvec{x}}} 
            + q(\vvec{v_x}\cross\vvec{B})\cdot\dd{\vvec{y}} 
            + q(\vvec{v_y}cross\vvec{B})\cdot\dd{\vvec{x}}
            + \cancelto[red]{0}{q(\vvec{v_y}cross\vvec{B})\cdot\dd{\vvec{y}}}\\
        &= q(\vvec{v_x}\cross\vvec{B})\cdot\dd{\vvec{y}}
            + q(\vvec{v_y}\cross\vvec{B})\cdot\dd{\vvec{x}} 
    }
    ...
    \aleq{
        ...
        qE_y\hhat{y} &= q\vvec{v}_x\cross B_z\hhat{z}\\        
    } 
    ...
    \aleq{
        q\vvec{E}\cdot\dd{\vvec{y}} &= q(\vvec{v}\cross\vvec{B})\cdot \dd{\vvec{y}}\\
        q \dd{\epsilon} &= q(\vvec{v}_x\cross\vvec{B})\cdot \dd{\vvec{y}}
    }
    ...
    \aleq{
        q\dd{\epsilon} &= \vvec{F}_\text{Lorentz}\cdot \dd{\vvec{y}}\\
        &= q(\vvec{v}\cross\vvec{B})\cdot\dd{\vvec{y}}\\
        &= q(\dd{\vvec{y}}\cross\vvec{v})\cdot \vvec{B}\\
        &= -q(\vvec{v}\cdot\dd{\vvec{y}})\cdot \vvec{B}
    }
\end{enumerate}
